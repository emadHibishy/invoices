    ...
    <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img src="{{ asset('backend/assets/images/flags/'.APP::getLocale().'.png') }}">
            </button>
            <div class="dropdown-menu">
                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                    <a href="{{ LaravelLocalization::getLocalizedURL($localeCode) }}" hreflang="{{ $localeCode }}" rel="alternate" class="dropdown-item">
                        ...
                        <img src="{{ asset('backend/assets/images/flags/'.$localeCode.'.png') }}">
                        {{ $properties['native'] }}
                    </a>
                @endforeach
            </div>
            ...
            <li class="nav-item dropdown mr-30">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{ route('login') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="text-danger ti-unlock"></i>Logout</a>
                    <form action="{{ LaravelLocalization::localizeURL('/logout') }}" method="POST" id="logout-form" style="display: none;">
                        @csrf
                    </form>
                </div>
            </li>
