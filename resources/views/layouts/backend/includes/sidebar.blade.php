...
{{--                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>--}}
            ...
            <li>
                <a href="/">
                    ...
                    <span class="right-nav-text">{{ __('backend/sidebar.home') }} </span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('terms.index') }}">
                    ...
                    <span class="right-nav-text">{{ __('backend/sidebar.terms') }} </span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('territories.index') }}">
                    ...
                    <span class="right-nav-text">{{ __('backend/sidebar.territories') }} </span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('customers.index') }}">
                    ...
                    <span class="right-nav-text">{{ __('backend/sidebar.customers') }} </span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('invoices.index') }}">
                    <i class="fa fa-shopping-bag"></i>
                    <span class="right-nav-text">{{ __('backend/sidebar.invoices') }} </span>
                </a>
            </li>

            <!-- Settings-->
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#settings-list">
                    <div class="pull-left"><i class="ti-settings"></i><span class="right-nav-text">{{ __('backend/sidebar.settings') }}</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="settings-list" class="collapse" data-parent="#sidebarnav">
