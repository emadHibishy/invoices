        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title"><div class="mb-30">
                        <h2>{{ __('backend/terms.add_term') }}</h2>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form action="{{ route('terms.store') }}" method="POST" autocomplete="off">
                    @csrf

                    <div class="row">
                        <div class="col">
                            <label>{{ __('backend/terms.ar_term_name') }}</label>
                            <input type="text" name="ar_term_name" class="form-control" >
                        </div>
                        <div class="col">
                            <label>{{ __('backend/terms.en_term_name') }}</label>
                            <input type="text" name="en_term_name" class="form-control " >
                        </div>
                        <div class="col">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <textarea class="form-control" name="ar_description" rows="3"></textarea>
                        </div>
                        <div class="col">
                            <label>{{ __('backend/terms.ar_term_description') }}</label>
                            <textarea class="form-control" name="en_description" rows="3"></textarea>
                        </div>
                    </div>
